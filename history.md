...
- `main.v`: `dialog_dest_idx []int` — маппинг индекса строки в диалоге на `destination_dirs` (починка delete dialog с пропущенными слотами)
...
- `dialog_dest_idx []int` — маппинг индекса строки в диалоге на индекс destination_dirs (исправление для delete dialog, где пустые слоты пропускаются)
...
## 2026-05-24 — NO-FILE в заголовке вместо модального окна

- При удалении несуществующего файла: красная вспышка + `NO-FILE path` в заголовке на 2 сек, без модального окна
